...
KIND_CLUSTER ?= memgraph-operator-test-e2e
...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name memgraph-operator-builder
	$(CONTAINER_TOOL) buildx use memgraph-operator-builder
	- $(CONTAINER_TOOL) buildx build --push --platform=$(PLATFORMS) --tag ${IMG} -f Dockerfile.cross .
	- $(CONTAINER_TOOL) buildx rm memgraph-operator-builder
	rm Dockerfile.cross
